...
3단계. 백업 후 교체
- 기존 v1 SKILL.md를 같은 위치에 SKILL-v1-backup-[오늘날짜].md 로 백업해.
- 개인화된 v2 세트(SKILL.md + references/ 폴더 + scripts/ 폴더)를 기존 스킬 위치에 복사해.
...
- **롤백**: 3단계에서 만든 백업 파일(`SKILL-v1-backup-날짜.md`)을 원래 이름으로 되돌리면 즉시 v1으로 복귀합니다.
